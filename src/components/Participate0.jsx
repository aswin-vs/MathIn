...
import squareTickHoverIcon from '../assets/squareTickHover.svg';
import squareTickOnIcon from '../assets/squareTickOn.svg';
import squareTickOffIcon from '../assets/squareTickOff.svg';
          ...
          <div className="participate0-container">
            ...
            {checkBoxOnStatus ? (
              <button className="participate0-proceed-btn-enabled" onClick={handleProceed}>
                <span>Proceed</span>
                <img className="participate0-proceed-icon" src={arrowRightIcon} alt="ProceedIcon" />
              </button>
            ) : (
